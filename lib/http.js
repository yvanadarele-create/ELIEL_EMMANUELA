...
/**
 * Téléphone ivoirien, ramené à la forme internationale.
 *
 * Le zéro de tête fait PARTIE du numéro et ne se retire pas. Depuis le passage
 * à dix chiffres en 2021, « 07 09 59 37 94 » vaut « +225 07 09 59 37 94 », pas
 * « +225 7 09 59 37 94 ». Le retirer fabrique un numéro injoignable — et, plus
 * insidieux, dédouble une même cliente selon qu'elle a tapé l'indicatif ou non.
 */
export function phone(value, field = "téléphone") {
  const raw = String(value ?? "").replace(/\D/g, "");
  const national = raw.startsWith("225") ? raw.slice(3) : raw;
